...
const BoostAndInterestContent = () => {
    const [searchQuery, setSearchQuery] = useState('');

    // Cards data
    const cardsData = [
        {
            title: 'Total Boost Allocated',
            amount: '₦32,450.00',
            change: '15.3%',
            icon: <>
    ...
    // Boost & Interest data
    const boostInterestData = [
        {
            savingsPlan: 'Education Funds',
            boostAllocated: '₦50,000',
            interestEarned: '₦50,000',
            status: 'Upcoming',
            dateGranted: 'Sep 15, 2025'
        },
        {
            savingsPlan: 'Home Renovation',
            boostAllocated: '₦25,000',
            interestEarned: '₦25,000',
            status: 'Upcoming',
            dateGranted: 'Sep 16, 2025'
        },
        {
            savingsPlan: 'Stock Investment',
            boostAllocated: '₦75,000',
            interestEarned: '₦75,000',
            status: 'Upcoming',
            dateGranted: 'Sep 20, 2025'
        },
        {
            savingsPlan: 'Vacation',
            boostAllocated: '₦10,000',
            interestEarned: '₦10,000',
            status: 'Paid',
            dateGranted: 'Sep 22, 2026'
        },
        {
            savingsPlan: 'Emergency Funds',
            boostAllocated: '₦60,000',
            interestEarned: '₦60,000',
            status: 'Paid',
            dateGranted: 'Sep 23, 2025'
        }
    ];

    // Table columns configuration
    const boostInterestColumns: TableColumn<typeof boostInterestData[0]>[] = [
        {
            key: 'savingsPlan',
            header: 'SAVINGS PLAN',
        ...
        {
            key: 'boostAllocated',
            header: 'BOOST ALLOCATED',
            accessor: 'boostAllocated',
            render: (value: string) => (
                ...
                <div className="rounded-xl p-4 sm:p-6 bg-[#1C1C1E] border-[#313135BA] border-2">
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-lg font-medium text-[#DEDEE3]">Boost & Interest</h2>
                            </div>
                        </div>
                    ...
                    {/* Table */}
                    <DataTable
                        data={boostInterestData}
                        columns={boostInterestColumns}
                        variant="dark"
...
export default BoostAndInterestContent